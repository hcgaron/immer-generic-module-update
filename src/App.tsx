...
function createUpdateSBTStateAction(payload: IADCScopedSBTState): UpdateSBTStateAction {
  return {
    type: ActionTypes.UpdateSBTState,
    payload
  }
...
export type updateStateFunction<T> = (recipe: (draft: Draft<T>) => void) => void;
...
function App() {
  ...
  function updateSBTState<IADCScopedSBTState>(recipe: updateStateFunction<IADCScopedSBTState>) {
  ...
  return (
    ...
    <SBT updateState={updateSBTState as any} />
  );
}
